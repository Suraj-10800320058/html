 ...
 document.write('<button style='+seffect+' oncontextmenu="return false" onfocus=this.blur(); onmouseover=bgfade(this); onmouseout=stopFade(this); onclick=\'location="user.jsp"\'>Home</button>&nbsp;&nbsp;&nbsp;')
